...
@Component({
  ...
  templateUrl: './list-article-categorie.component.html',
  styleUrls: ['./list-article-categorie.component.css']
})
export class ListArticleCategorieComponent implements OnInit {
